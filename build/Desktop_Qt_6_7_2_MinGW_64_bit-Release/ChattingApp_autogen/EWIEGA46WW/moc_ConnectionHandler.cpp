...
constexpr auto qt_meta_stringdata_CLASSConnectionHandlerENDCLASS = QtMocHelpers::stringData(
    "ConnectionHandler",
    "updateUI",
    "",
    "message",
...
Q_CONSTINIT const QMetaObject ConnectionHandler::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSConnectionHandlerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ConnectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateUI((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->updateClientList((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->removeFromClientList((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ConnectionHandler::*)(const QString & );
            if (_t _q_method = &ConnectionHandler::updateUI; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ConnectionHandler::*)(const QString & );
            if (_t _q_method = &ConnectionHandler::updateClientList; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ConnectionHandler::*)(const QString & );
            if (_t _q_method = &ConnectionHandler::removeFromClientList; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ConnectionHandler::updateUI(const QString & _t1)
{
...
// SIGNAL 1
void ConnectionHandler::updateClientList(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void ConnectionHandler::removeFromClientList(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
